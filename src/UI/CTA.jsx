...
export default function CTA() {
  return (
    ...
    >
      <div className="py-10 px-6 lg:px-10 w-128 bg-white">
        ...
        <button className="text-start bg-lipstick py-2 px-3 my-2 text-sm md:px-5 rounded-3xl text-white font-open">
