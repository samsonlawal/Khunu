export default function Footer() {
  return (
    <div className="px-4 pb-8 text-center md:text-left md:px-8 lg:flex lg:flex-row lg:justify-center lg:items-end">
      {/* Links */}
      <div className="py-8 lg:py-0 lg:mr-20 flex flex-col justify-center items-center md:flex-row md:justify-start md:items-end lg:flex lg:flex-row lg:justify-center lg:items-end">
        <div className="py-2 lg:py-0 mr-5">
